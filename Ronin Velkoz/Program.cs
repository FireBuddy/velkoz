    ...
    internal class Program
    {
	    ...
	    // var enemydirection = CurrentTarget.ServerPosition;
	     var startPos = Handle.Position.To2D();
		     ...
		     Circle.Draw(SharpDX.Color.White, 200, 200, intertwoD.To3D());
        ...
        private static void QSplitter3(EventArgs args)
        {
			...
			var enemydirection = (CurrentTarget.ServerPosition.To2D)).Normalized();
                        var skillshotline = ( Champion.ServerPosition.To2D() + enemydirection.Rotated(currentAngle) * 1100);
